...
/**
 * Circular seek bar view that will draw a seekbar anywhere
...
public class CircularSeekBar extends View {
    ...
    public interface OnCircularSeekBarChangeListener {
         ...
         *            The CircularSeekBar whose progress has changed
         * @param progress
         ...
         *
         * @param CircularSeekBar
         *            The CircularSeekBar in which the touch gesture began
         */
     ...
     *
     * @see com.sughoshkumar.looptest.CircularSeekBar.OnCircularSeekBarChangeListener
     */
